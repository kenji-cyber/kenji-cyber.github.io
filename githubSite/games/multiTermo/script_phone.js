...
const words_English = [
    ...
    "ULTRA", "VIVID", "WHALE", "YOUTH", "ZEBRA", "ANGEL", "BEACH", "CLIMB", "DREAM",
    "EVENT", "FLAME", "GRAPE", "HOUSE", "IMAGE", "JELLY", "KARMA", "LEMON", "MANGO", "NERDY",
    "ORBIT", "PAINT", "QUEEN", "ROBOT", "SUGAR", "TRACK", "UNDER", "VOCAL", "WRIST","YIELD",
    "ZESTY", "AMBER", "BLAZE", "CRISP", "DRIFT", "EMBER", "FLOOD", "GLOBE", "HINGE",
    "INFER", "JAUNT", "KIOSK", "LUNAR", "MINOR", "NUDGE", "OXIDE", "PEARL", "QUILT", "RISKY",
    "SPIKE", "TREND", "UNTIE", "VIGOR", "WRATH", "YOUNG", "ZONAL", "ALERT", "BLOOM",
  ...
  "STARS"
    ...
    "BURRO", "CABRA", "TERRA", "CASAL", "CHAVE", "FRUTA", "AMIGO", "AREIA","AVISO", "BABAR",
    "BANHO",  "BOLAS",
  "BOLSO",
  "BURRO",
  "CABRA",
